<%@ Page Title="" Language="C#" MasterPageFile="~/adminmaster.Master" AutoEventWireup="true" CodeBehind="a_addgotra.aspx.cs" Inherits="deul.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <h2><i class="fa fa-leaf"></i> Gotra Management</h2>
        <div class="mt-4">
            <h4 class="text-secondary"><i class="fa fa-plus-circle"></i> Add New Gotra</h4>
            <div class="form-group">
                <asp:Label ID="Label1" runat="server" Text="Gotra Name" CssClass="form-label"></asp:Label>
                <asp:TextBox ID="gname" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <asp:Button ID="ADD" runat="server" Text="Add Gotra" CssClass="btn btn-custom" OnClick="ADD_Click" />
            <div>
                <h4 class="text-secondary mt-4"><i class="fa fa-table"></i> Gotra List</h4>
