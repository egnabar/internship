<%@ Page Title="" Language="C#" MasterPageFile="~/Mahajan.Master" AutoEventWireup="true" CodeBehind="m_prasadbooking2.aspx.cs" Inherits="deul.WebForm24" %>
    ...
    <div class="container">
        ...
        <asp:Panel ID="bookingForm" runat="server">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="checkInDate" CssClass="form-control" type="date" runat="server" Placeholder="Select check-in date"></asp:TextBox>
            </div>
