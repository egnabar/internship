<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Mahajan.Master" AutoEventWireup="true" CodeBehind="m_passwordchange.aspx.cs" Inherits="deul.WebForm23" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <a href="m_homepage.aspx" class="btn btn-light btn-sm back-btn position-relative" style="right:-85%;">
